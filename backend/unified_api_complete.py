...
if __name__ == "__main__":
    ...
    print("📡 Main API: http://44.244.35.65:8000/main")
    print("🔧 Scrapers API: http://44.244.35.65:8000/scrapers")
    print("📊 System API: http://44.244.35.65:8000/system")
    print("📈 Dashboard API: http://44.244.35.65:8000/dashboard")
    print("🔌 Port 5002: http://44.244.35.65:8000/port-5002")
    print("🔌 Port 5003: http://44.244.35.65:8000/port-5003")
    print("🔌 Port 8001: http://44.244.35.65:8000/port-8001")
    print("🔌 Port 5021: http://44.244.35.65:8000/port-5021")
    print("🔌 Port 5023: http://44.244.35.65:8000/port-5023")
    print("🔌 Port 8002: http://44.244.35.65:8000/port-8002")
    print("📚 Documentation: http://44.244.35.65:8000/docs")
    print("💚 Health Check: http://44.244.35.65:8000/health")
